...
function add_theme_scripts() {
	if (is_page(8)) {
		wp_enqueue_style( 'style', get_template_directory_uri() . '/leverage-inventory/src/css/style.css' );
		wp_enqueue_script( 'd3', '//d3js.org/d3.v3.min.js');
		wp_enqueue_script( 'radialBarChart', get_template_directory_uri() . '/leverage-inventory/src/js/radialBarChart.js', array ( 'd3' ));
		wp_enqueue_script( 'app', get_template_directory_uri() . '/leverage-inventory/src/js/app.js', array ( 'd3','radialBarChart' ));
		wp_enqueue_script( 'print_app', get_template_directory_uri() . '/leverage-inventory/src/js/print_app.js', array ( 'd3','radialBarChart','app' ));
	}
}
